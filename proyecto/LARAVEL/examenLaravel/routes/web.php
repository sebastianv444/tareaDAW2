...
Route::get('crear','\App\Http\Controllers\ProveedorController@create');

Route::post('creando','\App\Http\Controllers\ProveedorController@salvar');

Route::get('detalle/{id}', '\App\Http\Controllers\ProveedorController@detalle');

// cliente:

Route::get('cliente','\App\Http\Controllers\ClienteController@index');

Route::get('cliente/crear','\App\Http\Controllers\ClienteController@create');

Route::post('cliente/creando','\App\Http\Controllers\ClienteController@salvar');

Route::get('cliente/detalle/{id}', '\App\Http\Controllers\ClienteController@detalle');

Route::get('clientes/cliente/{nombre}/{telefono}',[
    'middleware' => 'TestCliente',
    'uses'=> '\App\Http\Controllers\InformacionController@telefono'
]);

Route::get('datosDenegados','\App\Http\Controllers\InformacionController@denegado');

// Informacion:

Route::get('informacion','\App\Http\Controllers\InformacionController@index');

Route::get('informacion/telefonos/{admin?}',[
    'middleware' => 'TestAdmin',
    'uses'=> '\App\Http\Controllers\InformacionController@telefono'
]);

Route::get('denegado','\App\Http\Controllers\InformacionController@detalleEnEspecifico');
