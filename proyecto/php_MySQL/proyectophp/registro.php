<?php
    ...
    if(isset($_POST)){
        //no le damos un session_start, ya que al hacer el require_once viene ya con un session_start.
        require_once './includes/conexion.php';

        $nombre = isset($_POST['nombre']) ? $_POST['nombre']:false;
        $apellidos = isset($_POST['apellidos']) ? $_POST['nombre']:false;
        $email = isset($_POST['email']) ? $_POST['nombre']:false;
        $password = isset($_POST['password']) ? $_POST['nombre']:false;

        //validar los datos antes de introducirlos enla bases de datos:
