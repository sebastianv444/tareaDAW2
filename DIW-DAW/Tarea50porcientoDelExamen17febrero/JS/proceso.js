document.addEventListener("DOMContentLoaded", () => {
  ...
  const inglesSeccion1 = document.querySelector(".container__derecha--descripcion").innerHTML;
  ...
  const inglesSeccion2 = document.querySelector(".texto p").innerHTML;
  ...
  const inglesContainerExperiencia = document.querySelector(".experience-text p").innerHTML;
  const españolContainerExperiencia = `<span>+3</span> meses de <br>experiencia`;
  ...
  if (localStorage.getItem("idioma") === "es") {
    document.querySelector(".container__derecha--descripcion").innerHTML = españolSeccion1;
    document.querySelector(".texto p").innerHTML = españolSeccion2;
    document.querySelector(".experience-text p").innerHTML = españolContainerExperiencia;
  } else {
    document.querySelector(".container__derecha--descripcion").innerHTML = inglesSeccion1;
    document.querySelector(".texto p").innerHTML = inglesSeccion2;
    document.querySelector(".experience-text p").innerHTML = inglesContainerExperiencia;
  }
